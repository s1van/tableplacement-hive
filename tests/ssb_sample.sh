...
for rg in $RGS; do
	$WRAPD/test.sh SSB-Batch $rg ssb1 "$BUFS" "$OSRS" 8 1 "/home/siyuan/expr/tp-hive-test/ssb1-RG${rg}";
	#$WRAPD/test.sh SSB-Batch $rg ssb2 "$BUFS" "$OSRS" 8 1 "/home/siyuan/expr/tp-hive-test/ssb2-RG${rg}";
	$WRAPD/test.sh SSB-Batch $rg ssb3 "$BUFS" "$OSRS" 8 1 "/home/siyuan/expr/tp-hive-test/ssb3-RG${rg}";
done
