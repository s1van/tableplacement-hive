...
SSB_CG_NBVALS="2837046 0 410791940 17139259 166676"; #Set 0 for fixed size table
SSB_HDFS_R=/ssb;
...
TPCH_CG_NBVALS="30346144 803630406 0 171952161 24135125 118984616 0 1409184";
TPCH_HDFS_R=/tpch;
