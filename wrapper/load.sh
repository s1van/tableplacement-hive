...
TPCH_CG_NBVALS="30346144 813630406 0 171952161 24135125 118984616 0 1409184";
TPCH_HDFS_R=/tpch;
...
ssdb_default() { ssdb_$1 $TPLD/ssdb.load.sql.default.template $3 ${SSDB_HIVE_R}1 $2 '0.72'; } #default: 0.55
ssdb_v1() { ssdb_$1 $TPLD/ssdb.load.sql.v1.template $3 ${SSDB_HIVE_R}2 $2 '0.72'; } #without exra columns: 0.63, with two extra columns 0.685
