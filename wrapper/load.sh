...
ssdb_default() { ssdb_$1 $TPLD/ssdb.load.sql.default.template $3 ${SSDB_HIVE_R}1 $2 '0.66'; } #default: 0.55
ssdb_v1() { ssdb_$1 $TPLD/ssdb.load.sql.v1.template $3 ${SSDB_HIVE_R}2 $2 '0.66'; } #without exra columns: 0.63, with two extra columns 0.685
